                        ...
                        <?php foreach ($this->params['menu'] as $top) : ?>
                            ...
                            <li class="dropdown menu-item">
                                <a href="#" class="dropdown-toggle"
                                   data-toggle="dropdown"><?php echo $top['title']; ?></a>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="featured">
                    <div class="product-grid-holder">
                        ...
                        <?php foreach ($data['isreco'] as $pro) : ?>

                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    <div class="image">
                                        <img alt="<?php echo $pro->title; ?>"
                                             src="<?php echo $pro->cover; ?>-covermiddle"
                                             data-echo="<?php echo $pro->cover; ?>-covermiddle"/>
                                    </div>
                                    <div class="body">
                                        <div class="title">
                                            <a href="<?php echo \yii\helpers\Url::to([
                                                    'product/detail', 'productid' => $pro->productid
